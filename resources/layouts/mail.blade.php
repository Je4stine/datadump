			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.{{ $_SERVER['HTTP_HOST'] }}/">{{ $_SERVER['HTTP_HOST'] }}</a>
						</p>
					</td>
				</tr>
				<!-- Spacing -->
...
<table width="100%" bgcolor="#c5d1d9" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		<td>
			...
			<table width="580" bgcolor="#ffffff" style="" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				<tbody>
				<tr>
					<td>
						<!-- logo -->
							...
							<tr>
								<td valign="middle" width="270" style="padding: 4px 0px 2px 10px;" class="logo">
									<div class="imgpop">
										...
										</div> <a href="http://www.{{ $_SERVER['HTTP_HOST'] }}/"><img src="https://etbrains.com/wp-content/uploads/2016/07/main-logo.png" width="100%" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="logo" /></a>
									</div>
								</td>
							</tr>
							</tbody>
		...
		<td width="100%">
			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.{{ $_SERVER['HTTP_HOST'] }}/">http://www.{{ $_SERVER['HTTP_HOST'] }}/</a>
						</p>
						<p>							
							{{ $_SERVER['HTTP_HOST'] }} Writers
						</p>
						<p>
							Email: info@<?php echo $_SERVER['HTTP_HOST'] ?>
						</p>
					</td>
				</tr>
				<!-- Spacing -->
