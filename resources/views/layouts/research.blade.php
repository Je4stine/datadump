							...
							<tr>
								<td valign="middle" width="270" style="padding: 4px 0px 2px 10px;" class="logo">
									<div class="imgpop">
										...
										</div> <a href="http://www.{{ $_SERVER['HTTP_HOST'] }}/"><img src="http://imperialresearchers.com/wp-content/uploads/2016/07/Banner-Printscreened.png" width="100%" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="logo" /></a>
									</div>
								</td>
							</tr>
							</tbody>
