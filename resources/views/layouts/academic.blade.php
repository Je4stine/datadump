<html>
<head>    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Academic Writers Ebay </title><style type="text/css">
...
<table bgcolor="#c5d1d9" width="100%" cellpadding="0" cellspacing="0" border="0">
	<tbody>
	<tr>
		<td width="100%">
			<div class="innerbg">
			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.academic-writers-ebay.com/">academic-writers-ebay.com</a>
						</p>
					</td>
				</tr>
				<!-- Spacing -->
...
<table width="100%" bgcolor="#c5d1d9" cellpadding="0" cellspacing="0" border="0">
	<tbody>
	<tr>
		<td>
			<div class="innerbg">
			...
			<table width="580" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td>
						...
						<table width="270" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
							<tbody>
							<tr>
								<td valign="middle" width="270" style="padding: 4px 0px 2px 10px;" class="logo">
									<div class="imgpop">
										<div class="uploader_wrap" style="width: 100px; margin-top: -4.5px; opacity: 0;">
										...
										</div> <a href="http://www.academic-writers-ebay.com/"><img src="http://www.academic-writers-ebay.com/wp-content/uploads/2016/05/ebaylogo-4.png" width="100%" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="logo" /></a>
									</div>
								</td>
							</tr>
							</tbody>
		...
		<td width="100%">
			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.academic-writers-ebay.com/">http://www.academic-writers-ebay.com/</a>
						</p>
						<p>
							Academic Writers Ebay
						</p>
						<p>
							Email: info@academic-writers-ebay.com
						</p>
					</td>
				</tr>
				<!-- Spacing -->
