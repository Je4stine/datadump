<div class="card section">
    <div class="card-header">
        <div class="panel-title">{{ $user->email }} Payments</div>
    </div>
            ...
            <div class="card section">
                ...
                <div class="panel-body">
                    <table style="font-size: large;font-family: sans-serif, Verdana;" class="table table-">
                        <?php
                        $total_worked = $user->totalWorked(1);
                        $withdrawn = $user->totalWithdrawn(1);
                        $pending = $user->totalPending(1);
                        $fines = $user->totalFines(1);
                            ...
                            <td>${{ number_format($available,2) }}
                                @if(Auth::user()->id == $user->id)
                                    ...
                                    @else
                                        ...
                                        $day = $now->day;
                                        $allowed_days = [1,2,3,4,5,15,16,17,18,19,20,21];
            ...
            <div class="card section">
                ...
                <div class="panel-body">
                    <table class="table table-condesed">
                        ...
                        <?php
                        $no = 1;
                        $payouts  = $user->payments()->where('is_manual',1)->orderBy('id','desc')->get();
                        ?>
