                                            ...
                                            <div id="box_paper_type_id" class="row">
                                                ...
                                                <div aria-describedby="qtip-14" data-hasqtip="14"
                                                    ...
                                                    <select
                                                            ...
                                                            class="paper-type-id f_sz_400 validate[required] dr-down-input"
                                ...
                                @endforeach
                                            ...
                                            <div id="box_paper_type_id" class="row">
                                                ...
                                                <option>A4(British/Euaropean)</option>
                                            ...
                                            <div id="box_topcat_id" class="row">
                                                ...
                                                <div aria-describedby="qtip-16" data-hasqtip="16"
                                                    ...
                                                    <select
                                                            ...
                                                            class="topcat-id f_sz_400 validate[required] dr-down-input ">
                                            ...
                                            <div id="box_addmaterials" class="row">
                                                ...
                                                <div aria-describedby="qtip-22" data-hasqtip="22"
                                                    ...
                                                    <div id="order-customer-files-container"
                                                        ...
                                                        <a onclick="return addFiles();" href="#"><i class="fa fa-plus fa-lg"></i>ADD FILE</a>
                                                    </div>
...
//                                                        });
                                                        ...
                                                        $("div#my-awesome-dropzone").dropzone({
                                                            url: "{{ url("stud/files?_token=".csrf_token()) }}",
                                                            init: function() {

                                                                this.on("success", function(file, responseText) {
                                                                    console.log(responseText);
                                                                    $("#filesform").append('<br/><input type="hidden" class="form-control" value="'+responseText+'" name="file_ids[]">');
                                                                });
