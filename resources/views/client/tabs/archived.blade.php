<table class="table table-bordered table-striped">
    ...
    @foreach($orders as $order)
        ...
        <tr class="tabular">
            ...
            <th>
                <a class="btn btn-info btn-sm load-page" href="{{ URL::to('stud/order/'.''.$order->id) }}"><i class="fa fa-eye"></i> View</a>
                    <a class="btn btn-success btn-sm load-page" href="{{ URL::to('stud/restore/'.''.$order->id) }}"><i class="fa fa-refresh"></i> Restore</a>
        ...
        <div class="well well-lg col-md-12 gridular" style="padding-top: 10px;padding-bottom: 10px;">
            <div class="row">
                ...
                <div class="dropdown pull-right">
                    ...
                    <a class="btn btn-success btn-sm " href="{{ URL::to('stud/restore/'.''.$order->id) }}"><i class="fa fa-refresh"></i> Restore</a>
