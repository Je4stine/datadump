            ...
            <table class="table table-bordered table-striped">
                ...
                @foreach($orders as $order)
                    ...
                    <tr class="tabular">
                        ...
                        <td>
                         <a class="btn btn-info btn-xs" href="{{ URL::to('stud/order/'.''.$order->id.'#o_files') }}"><i class="fa fa-file"></i> Files</a><a class="btn btn-info btn-sm" href="{{ URL::to('stud/order/'.''.$order->id) }}"><i class="fa fa-eye"></i> View</a></td>
                    </tr>
                    <div class="row"></div>
