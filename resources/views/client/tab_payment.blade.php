       ...
       <div id="box_payment_system" class="row box_payment_system_logged ui-buttonset">
            ...
            <div aria-describedby="qtip-32" data-hasqtip="32" class="cell cell-right side_tip side_tip_payment_system">
                ...
                <div class="visible-in-desktop">
                    ...
                    <input style="display:none;" id="payment_method_payza" type="radio" title="asd" value=""
                           name="academiclevel" class="ui-helper-hidden-accessible"
                           checked="checked">
                    <label style="height:65px;padding-top: 10px;font-weight:500;font-size: medium;display:none;" id="payment_label_payza" onclick="setPaymentMethod('payza');" for="academic_input_56" data-hasqtip="0"
    ...
    function useCode(){
        ...
        $.get(url,{code:code,total:total},function(data){
            ...
            if(response.status){
                ...
                jQuery(".total_price_box_full_summary").html("$"+newtot.toFixed(2));
            }else{
