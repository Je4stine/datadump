...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-title">Email Templates <a onclick="return setEmail('','','');" href="#add_email_modal" class="pull-right btn btn-success" data-toggle="modal"><i class="fa fa-plus"></i> Add Email</a> </div>
        </div>
